    ...
    return (
        <div>
            <div class="container px-4 mx-auto">
                <div class="flex flex-wrap lg:items-center pt-10 -mx-4">
                    <div class="w-1/2 md:w-3/4 lg:w-1/6 px-4">
                        <img src="https://res.cloudinary.com/dwywbuukd/image/upload/v1715097915/new/logo_qbr1hv.png" alt="" />
                    </div>
                    <div class="w-full md:w-3/4 lg:flex-1 px-4">
                        <div class="flex flex-wrap justify-end -mx-3 lg:-mx-6">
                            <div class="w-full md:w-auto p-3 md:py-0 md:px-6"><a class="inline-block text-lg md:text-base text-coolGray-500 hover:text-coolGray-600 font-medium" href="#">Product</a></div>
                            <div class="w-full md:w-auto p-3 md:py-0 md:px-6"><a class="inline-block text-lg md:text-base text-coolGray-500 hover:text-coolGray-600 font-medium" href="#">Features</a></div>
                            <div class="w-full md:w-auto p-3 md:py-0 md:px-6"><a class="inline-block text-lg md:text-base text-coolGray-500 hover:text-coolGray-600 font-medium" href="#">Pricing</a></div>
                            <div class="w-full md:w-auto p-3 md:py-0 md:px-6"><a class="inline-block text-lg md:text-base text-coolGray-500 hover:text-coolGray-600 font-medium" href="#">Resources</a></div>
                            <div class="w-full md:w-auto p-3 md:py-0 md:px-6"><a class="inline-block text-lg md:text-base text-coolGray-500 hover:text-coolGray-600 font-medium" href="#">Careers</a></div>
                            <div class="w-full md:w-auto p-3 md:py-0 md:px-6"><a class="inline-block text-lg md:text-base text-coolGray-500 hover:text-coolGray-600 font-medium" href="#">Help</a></div>
                            <div class="w-full md:w-auto p-3 md:py-0 md:px-6"><a class="inline-block text-lg md:text-base text-coolGray-500 hover:text-coolGray-600 font-medium" href="#">Privacy</a></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container px-4 mx-auto">
                <div class="flex flex-wrap items-center md:pb-12">
                    <div class="w-full md:w-1/2 mb-6 md:mb-0">
                        <p class="text-coolGray-400 font-medium">© 2024. All rights reserved.</p>
                    </div>
