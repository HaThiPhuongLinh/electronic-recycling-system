  ...
  return (
    <div class="container px-4 mx-auto mt-4">
      <div class="max-w-lg mx-auto text-center mt-5">
        <h1 class="text-4xl font-bold text-black mb-4">Assessment</h1>
      </div>
        ...
        <table className="min-w-full bg-white">
          <thead className="sticky top-0 bg-white shadow">
            <tr>
              ...
              <th className="py-2 text-left text-gray-500">External Review Date</th>
          ...
          <tbody>
            {filteredData.map((item, index) => (
              <tr key={index} className="border-t">
                ...
                <td className="py-2">{item.internalEvaluatingStatus}</td>
                <td className="py-2">
                  <button
      ...
      {isModalOpen && <AssessmentModel data={selectedItem} closeModal={closeModal} />}
    </div>
  );
};
