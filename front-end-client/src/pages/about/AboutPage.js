            ...
            <div class="max-w-6xl mx-auto">
                ...
                <div class="flex -mx-4 mb-16 items-center justify-center">
                    <div class="w-full md:w-1/2 px-4">
                        <img class="block w-full h-40 md:h-64 lg:h-96 rounded-xl" src="https://res.cloudinary.com/dwywbuukd/image/upload/v1715096099/new/b1_w8efjj.png" alt="" />
                    </div>
                    <div class="w-full md:w-1/2 px-4">
                        <img class="block w-full h-40 md:h-64 lg:h-96 rounded-xl" src="https://res.cloudinary.com/dwywbuukd/image/upload/v1715096095/new/b2_gi7s2g.png" alt="" />
                    </div>
                </div>
